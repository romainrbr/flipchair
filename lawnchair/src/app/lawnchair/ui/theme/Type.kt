...
val Typography = Typography(
    ...
    bodyLarge = base.bodyLarge.copy(fontFamily = GoogleSansFlex.Body.Emphasized.Large, letterSpacing = 0.sp),
    bodyMedium = base.bodyMedium.copy(fontFamily = GoogleSansFlex.Body.Emphasized.Medium, letterSpacing = 0.1.sp),
    bodySmall = base.bodySmall.copy(fontFamily = GoogleSansFlex.Body.Emphasized.Small),
    labelLarge = base.labelLarge.copy(fontFamily = GoogleSansFlex.Label.Emphasized.Large),
    labelMedium = base.labelMedium.copy(fontFamily = GoogleSansFlex.Label.Emphasized.Medium),
    labelSmall = base.labelSmall.copy(fontFamily = GoogleSansFlex.Label.Emphasized.Small),
